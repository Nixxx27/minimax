        ...
        <div class="flex-grid no-responsive-future" style="height: 100%;">
            <div class="row" style="height: 100%">
               <div class="cell size-x200" id="cell-sidebar" style="background-color: #71b1d1; height: 100%">
                    ...
                    <h1 class="text-light">Work Order<span class="mif-cogs place-right   mif-ani-heartbeat mif-ani-slow"></span></h1>
                    <hr class="thin bg-grayLighter">
                    <a href="new-workorder.php">
                    <button class="button primary loading-pulse"><span class="mif-plus"></span> New Workorder...</button>
                    </a>
