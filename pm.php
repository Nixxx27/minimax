               ...
               <div class="cell size-x200" id="cell-sidebar" style="background-color: #71b1d1; height: 100%">
                    <ul class="sidebar">
                        <li><a href="#">
                            ...
                            <span class="title">Preventive Maintenance Lists</span>
                    ...
                    <h1 class="text-light">Preventive Maintenance<span class="mif-cogs place-right   mif-ani-heartbeat mif-ani-slow"></span></h1>
                    <hr class="thin bg-grayLighter">
                    <a href="new-pm.php">
                    <button class="button primary loading-pulse"><span class="mif-plus"></span> New PM...</button>
                    </a>
